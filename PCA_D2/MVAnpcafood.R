...
# ------------------------------------------------------------------------------
# Description:  MVAnpcafood performs a PCA for the standarized French food data 
#               (food.dat) and shows the first two principal components in for 
#               the individuals and the variables. The normalization corresponds  
#               to that of Lebart/Morineau/Fenelon.
# ------------------------------------------------------------------------------
# keywords:     PCA, dimension reduction, eigenvalues, normalization, principal components, standardize
# ------------------------------------------------------------------------------
# Usage:        -
# ------------------------------------------------------------------------------
# Inputs:       None      
...
# Example:      - 
# ------------------------------------------------------------------------------
# Author:       Zografia Anastasiadou 20110214
#                   Edit: Awdesch Melzer 20140403
# ------------------------------------------------------------------------------

#clear variables, close windows
rm(list = ls(all = TRUE))
graphics.off()
setwd("/Users/ookhrin/Documents/Private/Lehre/MVA2/_excersises/PCA")
#load data
...
#plot for the representation of the individuals
dev.new()
plot(w, type = "n", xlab = "First Factor - Families", ylab = "Second Factor - Families", main = "French Food data", cex.lab = 1.2, cex.axis = 1.2, cex.main = 1.8, lwd = 2)
text(w, c("MA2", "EM2", "CA2", "MA3", "EM3", "CA3", "MA4", "EM4", "CA4", "MA5", "EM5", "CA5"), cex = 1.2)
abline(h = 0.0, v = 0.0)
...
#plot for the representation of the variables
dev.new()
